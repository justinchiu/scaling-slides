...
\vspace{2em}
\item Emission sparsity induces sparsity in transition operators (not the transition
    matrix)
\vspace{2em}
...
Factor transition matrix $A\in[0,1]^{Z\times Z}$ into product of $U,V\in\R^{Z \times R}$
\[
\vcenter{\hbox{\begin{tikzpicture}[baseline=-0.5ex]
