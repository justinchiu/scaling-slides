...
Interpretable models provide insight into their generative processes

\vspace{2em}
A short look at 3 interpretable models with increasing flexibility:
\vspace{2em}
\begin{itemize}
\item Topic Model
\vspace{2em}
...
\begin{frame}
\frametitle{Interpretable Models: Topic Model}
\centering
\includegraphics[height=2in]{img/topic_model.png}

\begin{itemize}
\item Does not directly model relationship between nearby words
\end{itemize}
...
\begin{itemize}
\item Produces chunks of text
\item Simple dependencies between chunks
\end{itemize}
\end{frame}
...
\begin{itemize}
\item Recognizes and maintains information about entities
\item Uses an uninterpretable language model for everything else
\end{itemize}
\end{frame}
...
Interpretable models have the following qualities
\vspace{1em}
\begin{itemize}
\item Modularity
\vspace{0.5em}
    \begin{itemize}
    \item Breaks complex decisions down into simple ones
    \end{itemize}
\vspace{1em}
\item Simple dependencies
\vspace{0.5em}
    \begin{itemize}
    \item Effects of decisions are local
    \end{itemize}
\vspace{1em}
\item Simple alternatives
\vspace{0.5em}
    \begin{itemize}
    \item Simple decisions have choices that are easy to reason through
    \end{itemize}
\end{itemize}
\vspace{1em}
These qualities also limit model expressivity
\end{frame}

\begin{frame}
\frametitle{Hidden Markov Language Models}
\begin{itemize}
\item Modularity and simple dependencies as design decisions
\vspace{2em}
