...
\begin{tikzpicture}
\draw [fill=black] (0,0) rectangle (9,4);

\fill [white] (0,4) rectangle (1,3);
\fill [white] (1,3) rectangle (2,2);
\fill [white] (2,2) rectangle (3,1);
\fill [white] (3,2) rectangle (4,1);
\fill [white] (4,1) rectangle (5,0);
\fill [white] (5,3) rectangle (6,2);
\fill [white] (6,3) rectangle (7,2);
\fill [white] (7,4) rectangle (8,3);
\fill [white] (8,3) rectangle (9,2);
\end{tikzpicture}
}
\end{center}
